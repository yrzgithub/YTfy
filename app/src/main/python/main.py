        ...
        for contents in data["contents"]["twoColumnSearchResultsRenderer"]["primaryContents"]["sectionListRenderer"]["contents"]:
            for video in contents["itemSectionRenderer"]["contents"]:
                ...
                if "videoRenderer" in video.keys():
                    ...
                    res["thumbnail"] = video_data.get("thumbnail", {}).get("thumbnails", [{}])[0]["url"]
                    ...
                    res["channel_thumbnail"] = video_data.get('channelThumbnailSupportedRenderers').get('channelThumbnailWithLinkRenderer').get("thumbnail").get("thumbnails")[0]["url"]
